...
When you add a repository to a workspace, Agentic Kanban creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.agentic-kanban-workspaces` directory (configurable in Settings).
</Accordion>
