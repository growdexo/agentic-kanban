...
<Tip>
For detailed setup instructions and examples, see the [Agentic Kanban MCP Server](/integrations/agentic-kanban-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Agentic Kanban project based on this description.
