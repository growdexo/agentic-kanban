...
<Step title="Authenticate with Factory AI">
  To use Droid in Agentic Kanban, you must first authenticate:
...
Droid supports several configuration options in Agentic Kanban:
...
These options can be configured when creating agent configurations in Agentic Kanban.
