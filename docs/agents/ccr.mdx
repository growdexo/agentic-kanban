...
## Authentication
Authenticate and configure CCR outside of Agentic Kanban. Follow the instructions on the CCR GitHub repo:
...
## Configure Agentic Kanban

Agentic Kanban does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Agentic Kanban

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Agentic Kanban" />
</Frame>

## Using CCR in Agentic Kanban
