...
<Info>
Agent profiles are used throughout Agentic Kanban wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Agentic Kanban saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Agentic Kanban for your coding agents
</Card>

<Card title="Agentic Kanban MCP Server" icon="plug" href="/integrations/agentic-kanban-mcp-server">
  Connect external MCP clients to Agentic Kanban's MCP server
</Card>
</CardGroup>
