---
title: "Agentic Kanban Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

<Note>
Agentic Kanban Cloud is currently in <Badge color="orange">Beta</Badge>. Features may change before stable release.
</Note>

## What is Agentic Kanban Cloud?

**Agentic Kanban Cloud** adds team collaboration to Agentic Kanban. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Agentic Kanban interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Agentic Kanban installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Agentic Kanban** as usual with `npx agentic-kanban`
...
Think of it as your company or team in Agentic Kanban.
...
- Review code directly in Agentic Kanban
- Track PR status

## Getting Started

<Steps>
<Step title="Run Agentic Kanban">
  ```bash
  npx agentic-kanban
  ```
</Step>
