...
description: "Solutions for common issues with Agentic Kanban Cloud"
---

This page covers common issues you might encounter with Agentic Kanban Cloud and how to resolve them.
...
4. Return to Agentic Kanban and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Agentic Kanban (`npx agentic-kanban`)
</Accordion>
...
1. **Check existing issues:** [github.com/growdexo/agentic-kanban/issues](https://github.com/growdexo/agentic-kanban/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/growdexo/agentic-kanban/issues/new">
